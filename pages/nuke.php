<?php
//credit to the OG creator of the user nuke plugin for ABXD
//credit to 8JeDaYoshi8 for the Blargboard port
//credit to EzioisAwesome56 for Blargbaord 1.2.1 intergration
