...
if(!isset($base) || strpos($base, ".") !== FALSE)
	Kill("Invalid base layout. (error 3)");

$basefile = "pages/bases/".$base.".php";
if(is_file($basefile))
	include($basefile);
else
	Kill("Invalid base layout. (error 4)");
...
$previewPost['u_signature'] = trim(ApplyParameters($markupTemplateA.$markupTemplateB));
