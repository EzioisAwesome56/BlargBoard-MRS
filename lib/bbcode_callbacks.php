...
function bbcodeMeme($contents, $arg, $parenttag)
{
	...
	elseif ($contents == '4')
		return '<img class="imgtag" style="max-width:300px; max-height:300px;" src="../../instameme/instameme4.jpg" alt="Instameme4"/>';
	elseif ($contents == '5')
		return '<img class="imgtag" style="max-width:300px; max-height:300px;" src="../../instameme/instameme5.png" alt="Instameme5"/>';
	elseif ($contents == '6')
		return '<img class="imgtag" style="max-width:300px; max-height:300px;" src="../../instameme/instameme6.jpg" alt="Instameme6"/>';
	elseif ($contents == '7')
		return '<img class="imgtag" style="max-width:300px; max-height:300px;" src="../../instameme/instameme7.png" alt="Instameme7"/>';
