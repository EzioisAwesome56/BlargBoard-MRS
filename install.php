...
?>';
	if (file_put_contents('config/database.php', $dbconfig) === FALSE)
		die('Error: failed to create the config file. Check the permissions of the user running PHP and make sure it can write to the config folder.'.$footer);
	...
	//Not much change on this line, just an edit to set the default rankset to mario
	Query("insert into {users} (id, name, password, pss, primarygroup, regdate, lastactivity, lastip, email, sex, theme, rankset) values ({0}, {1}, {2}, {3}, {4}, {5}, {5}, {6}, {7}, {8}, {9}, 'mario')", 
